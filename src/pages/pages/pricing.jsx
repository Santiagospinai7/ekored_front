...
import {MdOutlineKeyboardArrowRight, AiOutlineCheckCircle, AiOutlineClose} from '../../assets/icons/vander'
                                ...
                                <div className="grid lg:grid-cols-4 md:grid-cols-2 mt-6 gap-6">
                                    <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 h-fit">
                                        ...
                                        <div className="p-6 border-t border-gray-100 dark:border-gray-800">
                                            ...
                                            <Link to="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-md w-full mt-6">Signup Now</Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 h-fit">
                                        ...
                                        <div className="p-6 border-t border-gray-100 dark:border-gray-800">
                                            ...
                                            <Link to="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-md w-full mt-6">Select Now</Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 h-fit">
                                        ...
                                        <div className="p-6 border-t border-gray-100 dark:border-gray-800">
                                            ...
                                            <Link to="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md w-full mt-6">Buy Now</Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 h-fit">
                                        ...
                                        <div className="p-6 border-t border-gray-100 dark:border-gray-800">
                                            ...
                                            <Link to="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-md w-full mt-6">Buy Now</Link>
                                        </div>
                                    </div>
                                </div>
                            </div> :''
