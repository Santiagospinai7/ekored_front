...
import { LuSearch, AiOutlineUser, FaRegComment, MdMailOutline, AiOutlineSetting, BiLockAlt, IoMdLogOut } from '../assets/icons/vander'
          ...
          <div className="flex items-center space-x-1">
            ...
            <div className="ps-1.5">
              <div className="form-icon relative sm:block hidden">
                ...
                <input type="text" className="form-input w-56 ps-9 py-2 px-3 h-8 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-3xl outline-none border border-gray-100 dark:border-gray-800 focus:ring-0 bg-white" name="s" id="searchItem" placeholder="Buscar..." />
              </div>
            </div>
          </div>
          ...
          <ul className="list-none mb-0 space-x-1">
            ...
            <li className="dropdown inline-block relative">
              <button onClick={()=> setUser(!user)} className="dropdown-toggle items-center" type="button">
                ...
                <span className="font-semibold text-[16px] ms-1 sm:inline-block hidden">Marta Cadavid</span>
              </button>
